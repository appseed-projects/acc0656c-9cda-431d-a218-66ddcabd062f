...
> Built with [App Generator](https://appseed.us/generator/), timestamp `2023-03-13 00:47`
...
```bash
$ # Get the code
$ git clone https://github.com/appseed-projects/acc0656c-9cda-431d-a218-66ddcabd062f.git
$ cd acc0656c-9cda-431d-a218-66ddcabd062f
```
